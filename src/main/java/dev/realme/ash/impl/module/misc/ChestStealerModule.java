...
public class ChestStealerModule extends ToggleModule {
    final Config<Float> disableTime = new NumberConfig<>("DisableTime", "Added delays", 0.0F, 60.0F, 500.0F);
    final Config<Boolean> smart = new BooleanConfig("Smart", "", true);
    ...
    final Config<Boolean> preferOpen = new BooleanConfig("PreferOpen", "", true);
    final Config<Float> minRange = new NumberConfig<>("MinRange", "", 0.0F, 1.0F, 3.0F);
    final Config<Boolean> mine = new BooleanConfig("Mine", "", true);
    final Config<Boolean> open = new BooleanConfig("Open", "", true);
    final Config<Boolean> take = new BooleanConfig("Take", "", true);
    final Config<Boolean> autoDisable = new BooleanConfig("AutoDisable", "", true);
    final Config<Integer> crystal = new NumberConfig<>("Crystal", "", 0, 256, 512);
    final Config<Integer> exp = new NumberConfig<>("Exp", "", 0, 256, 512);
    final Config<Integer> totem = new NumberConfig<>("Totem", "", 0, 7, 36);
    final Config<Integer> gapple = new NumberConfig<>("GApple", "", 0, 256, 512);
    final Config<Integer> endChest = new NumberConfig<>("EndChest", "", 0, 64, 512);
    final Config<Integer> web = new NumberConfig<>("Web", "", 0, 256, 512);
    final Config<Integer> glowstone = new NumberConfig<>("GlowStone", "", 0, 256, 512);
    final Config<Integer> anchor = new NumberConfig<>("Anchor", "", 0, 256, 512);
    final Config<Integer> pearl = new NumberConfig<>("Pearl", "", 0, 16, 512);
    final Config<Integer> turtle = new NumberConfig<>("Turtle", "", 0, 6, 36);
