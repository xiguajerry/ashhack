...
extends ToggleModule {
    ...
    Config<Float> delayConfig = new NumberConfig<Float>("Delay", "The delay before accepting teleport requests", Float.valueOf(0.0f), Float.valueOf(3.0f), Float.valueOf(10.0f));
    ...
    public void onPacketInbound(PacketEvent.Receive event) {
        ...
        if (packet2 instanceof ChatMessageS2CPacket && ((text = (packet = (ChatMessageS2CPacket)((Object)packet2)).body().content()).contains("has requested to teleport to you.") || text.contains("has requested you teleport to them.")) && this.acceptTimer.passed(Float.valueOf(this.delayConfig.getValue().floatValue() * 1000.0f))) {
